...
-- CreateEnum
CREATE TYPE "Day" AS ENUM ('MONDAY', 'TUESDAY', 'WEDNESSDAY', 'THURSDAY', 'FRIDAY');
...
CREATE TABLE "Attemdance" (
    ...
    CONSTRAINT "Attemdance_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "Attemdance" ADD CONSTRAINT "Attemdance_studentId_fkey" FOREIGN KEY ("studentId") REFERENCES "Student"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Attemdance" ADD CONSTRAINT "Attemdance_lessonId_fkey" FOREIGN KEY ("lessonId") REFERENCES "Lesson"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Anouncement" ADD CONSTRAINT "Anouncement_classId_fkey" FOREIGN KEY ("classId") REFERENCES "Class"("id") ON DELETE SET NULL ON UPDATE CASCADE;
