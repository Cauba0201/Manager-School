...
const SingleTeacherPage = async ({
  ...
  return (
    <div className="flex-1 flex flex-col gap-4 xl:flex-row mx-4">
      {/* LEFT */}
      <div className="w-full xl:w-2/3">
        {/* TOP */}
        <div className="flex flex-col lg:flex-row gap-4">
          {/* USER INFO CARD */}
          <div className="bg-lamaSky py-6 px-4 rounded-md flex-1 flex gap-1">
            <div className="w-1/3 ">
              <Image
            ...
            <div className="w-2/3 flex flex-col justify-between gap-4">
              ...
              <div>
                ...
                <div className="w-full md:w-1/3 lg:w-full 2xl:w-1/3 flex items-center gap-2">
                  ...
                  <span>
                    {/* chuyen doi thanh thoi gian ngya gio */}
                    {new Intl.DateTimeFormat("en-GB").format(teacher.birthday)}
                  </span>
                </div>
                <div className="w-full md:w-1/3 lg:w-full 2xl:w-1/3 flex items-center gap-2">
                  <Image src="/mail.png" alt="" width={14} height={14} />
                  <span>{teacher.email || NaN}</span>
                </div>
                <div className="w-full md:w-1/3 lg:w-full 2xl:w-1/3 flex items-center gap-2">
                  <Image src="/phone.png" alt="" width={14} height={14} />
                  <span>{teacher.phone || NaN}</span>
                </div>
              </div>
            </div>
          </div>
